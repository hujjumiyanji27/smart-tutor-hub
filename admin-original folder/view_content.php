...
<section class="view-content">
    ...
    <div class="container">
        ...
        <!-- Debug File Paths -->
        <p>Video Path: ../uploaded_files/<?= $fetch_content['video']; ?></p>
        <p>Thumbnail Path: ../uploaded_files/<?= $fetch_content['thumb']; ?></p>

        <!-- Check if files exist -->
        <?php
        if (!file_exists('../uploaded_files/' . $fetch_content['video'])) {
            echo '<p style="color:red;">Video file not found!</p>';
        }
        if (!file_exists('../uploaded_files/' . $fetch_content['thumb'])) {
            echo '<p style="color:red;">Thumbnail file not found!</p>';
        }
        ?>
    ...
    <?php
        ...
        echo '<p class="empty">No content found! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">Add Videos</a></p>';
    }
    ?>
